...
Each button in the second row is a **three-state switch**. Click it to cycle through:
...
| <img class="inline-ic" src="/icons/api.png" alt="" /> **Webhook** | Associate a webhook, so completing/reopening the task fires an HTTP call. | — |
...
- [Webhooks](/docs/webhooks/) — connect a task to the outside world.
