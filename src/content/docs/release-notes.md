...
- **Reopen all** brings every completed task back to to-do on the same message, keeping text, owners, tags and reminders. With **New date** the reminders move too: the oldest one lands on the date you pick, the others keep the same distance from it. No webhook is called.
